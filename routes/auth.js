...
//@Method    POST
//@Access    Private
router.post("/current-user", auth, currentUser);//ตรวจสอบว่าเป็น user หรือไม่

//@Endpoint  http://localhost:3000/api/current-admin
//@Method    POST
//@Access    Private
router.post("/current-admin", auth,adminCheck, currentUser);//ตรวจสอบว่าเป็น admin หรือไม่
